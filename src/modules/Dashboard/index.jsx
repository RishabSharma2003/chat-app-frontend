...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchConversations = async () => {
      ...
      const res = await fetch(`https://chat-app-backened.vercel.app/api/conversations/${loggedInUser.id}`, {
        method: 'GET',
        headers: {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      const res = await fetch(`https://chat-app-backened.vercel.app/api/users/${user?.id}`, {
        method: 'GET',
        headers: {
          'Content-Type': 'application/json'
        }
  ...
  const fetchMessages = async (conversationId, receiver) => {
    ...
    const res = await fetch(`https://chat-app-backened.vercel.app/api/message/${conversationId}?senderId=${user?.id}&&receiverId=${receiver?.receiverId}`, {
      method: 'GET',
      headers: {
        'Content-Type': 'application/json',
      }
  ...
  const sendMessage = async (e) => {
    try {
      ...
      const res = await fetch(`https://chat-app-backened.vercel.app/api/message`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
